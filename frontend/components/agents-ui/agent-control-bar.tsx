...
export function AgentControlBar({
  ...
  /** LiveKit pill styling expects outline track controls (variant === 'livekit' is not handled by 'default'). */
  const trackVariant = variant === 'outline' || variant === 'livekit' ? 'outline' : 'default';
